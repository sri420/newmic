...
public class NewmicApp {

    private static final Logger log = LoggerFactory.getLogger(NewmicApp.class);

    private final Environment env;

    public NewmicApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(NewmicApp.class);
